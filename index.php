...
<body>
<a href="create.php">Add new student
</a><br/><br/>
    <table width="90%" border="1">
        <tr>
            <th>Name</th><th>Moblie</th><th>Email</th><th>Update</th>
        </tr>
        <?php
        while ($student_data = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='edit.php?id=$student_data[id]'>Edit</a> |<a href='delete.php?id=$student_data[id]'>Delete</a></td></tr>";
